...
local Weapons, Armor, Containers, Consumables, Glyphs, TradeGoods, Recipes, Gems, Miscellaneous, Quest, BattlePet =
...
local Devices = GetItemSubClassInfo(LE_ITEM_CLASS_TRADEGOODS, 3)
