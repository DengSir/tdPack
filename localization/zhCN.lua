...
L['JPack not loaded.'] = 'JPack 没有载入'
L['Import JPack rules will |cffff0000clear the current rules|r and |cffff0000reload addons|r, continue?'] = '导入JPack规则将|cffff0000清空现有规则|r和|cffff0000重载插件|r，是否继续？'